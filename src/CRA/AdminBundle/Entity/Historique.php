...
class Historique
{
     ...
     * @var string
     *
     * @ORM\Column(name="heurd", type="string", length=30, nullable=false)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="heurf", type="string", length=30 , nullable=false)
     */
    private $heurf;
     ...
     * @var string
     *
     * @ORM\Column(name="loctravail", type="string", length=30, nullable=false)
     */
    private $loctravail;
